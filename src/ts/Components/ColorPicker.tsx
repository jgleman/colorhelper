      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            id={id}
            type="text"
            className="h-10 w-72 rounded border border-zinc-200 p-2 font-mono"
            value={baseColor}
          ...
          />
          <input
            className="h-10 w-10 cursor-pointer appearance-none border border-zinc-400 disabled:cursor-default"
            type="color"
            value={baseColor}
